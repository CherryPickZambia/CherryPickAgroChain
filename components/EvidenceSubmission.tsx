      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className={`flex items-center gap-3 p-4 rounded-xl ${
            location ? "bg-emerald-50 border border-emerald-200" : "bg-yellow-50 border border-yellow-200"
          }`}>
            <MapPin className={`h-5 w-5 ${location ? "text-emerald-600" : "text-yellow-600"}`} />
            <div className="flex-1">
              <p className={`font-semibold ${location ? "text-emerald-900" : "text-yellow-900"}`}>
